...
export const metadata: Metadata = {
  title: "Privacy",
  description:
    "How CertaNest handles your documents, account, sharing, and analytics data. A private-beta draft, reviewed before public launch.",
...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    body: "Dates you add (such as document expiry, renewal, and application deadlines) are used to remind you before they pass. CertaNest does not process payments and does not connect to your bank or card accounts.",
  },
  {
  ...
  },
  {
    ...
    body: "CertaNest may derive coarse, country-level activity from request metadata (such as IP) for security and product operations. Raw IP addresses are not shown in normal internal product views.",
  },
  {
    title: "11. Cookies and local storage",
    body: "CertaNest uses browser storage to keep you signed in and to remember interface preferences. During development, tokens may be held in local storage; production aims to move toward safer cookie-based handling.",
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "Limited service providers (such as hosting and email) may process data on CertaNest's behalf to operate the service.",
    ],
  },
  {
...
export default function PrivacyPage() {
  return (
    <LegalShell
      eyebrow="Privacy"
      title="Privacy draft"
      intro="How CertaNest handles your documents, account, sharing, and analytics data. This is a beta-ready product draft, not final legal policy."
      sections={sections}
      footerLinks={[
