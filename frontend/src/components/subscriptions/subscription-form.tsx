...
export function SubscriptionForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      ...
      <Section title="Subscription" description="What is this recurring payment?">
      ...
      <Section title="Cost & billing" description="Used for cost summaries and renewal dates.">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <Field
            ...
            hint="DueNest shows this in Calendar and Timeline."
          >
            <Input
              type="date"
      ...
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <Field
            ...
            hint="The last day you can cancel before renewal."
          >
            <Input
              type="date"
      ...
      <Section
        title="Value & details"
        description="Optional context to help you decide what to keep."
      >
        <div className="grid gap-4 sm:grid-cols-2">
