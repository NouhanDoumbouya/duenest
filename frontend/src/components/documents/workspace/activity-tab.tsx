...
import { getDocumentActivity } from "@/lib/documents";
...
export function ActivityTab({ documentId }: { documentId: number }) {
  ...
  return (
    <SectionCard
      ...
      description="Everything that's happened with this document, its files, and its shares."
    >
      {error && (
        <p
      ...
      {events === null ? (
        ...
        <EmptyState
          ...
          description="As you upload files, share, and update this document, the history will appear here."
        />
      ) : (
