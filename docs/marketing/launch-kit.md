...
[brand foundation](../../brand/README.md).
...
- **Long pitch:** DueNest is a private life-document readiness platform. It helps
  ...
  and drives, you keep everything in a secure Vault, track what expires, build
  complete application packs, and share with expiry and revocation — not a public
  link. AI helps as a review-first assistant; you stay in control.

## Feature descriptions (one line each)

- **Vault** — Your secure home for important documents.
- **File Inbox** — New scans and uploads waiting to be organized.
- **Scan** — Capture a clean PDF with your camera.
- **Document Tools** — Prepare, convert, compress, watermark, fill, sign, export.
- **Deadlines & Renewals** — Track expiry dates, deadlines, renewals, reminders.
- **Application Packs** — Complete document sets for visas, scholarships, jobs,
  university, travel, renewals, and custom needs.
- **SafeSend** — Share sensitive documents with expiry, access control, and revocation.
- **Custom QR** — A branded QR that follows your SafeSend access rules.
...
- **Students:** Documents scattered across phone, email, WhatsApp, and Drive →
  keep academic, visa, scholarship, and job documents ready → *Start organizing for free.*
- **Visa applicants:** Missing or expired documents delay applications → prepare
  visa documents, track expiry, share safely → *Prepare a visa pack.*
- **Scholarship applicants:** Packs come together last-minute and incomplete →
  build a complete scholarship pack with checklist and drafts → *Create an application pack.*
- **Job applicants:** Every role needs a tailored CV, letters, and certificates →
  build a job pack and track each deadline → *Create a job pack.*
- **Families:** Critical documents must be findable in an emergency → Vault +
  Emergency Access for trusted people → *Set up emergency access.*
- **Agencies / schools / HR / NGOs:** Collecting documents from many people is
  chaotic → request, review, track, and safely manage submissions → *Create a portal.*
...
> unless you confirm. We'd love your honest feedback.
...
- **Is my data private?** Documents are private until you choose to share. No
  ...
  revoked.
- **Can I share safely?** Yes — SafeSend adds expiry, access rules, QR, and
  revocation. We don't claim third-party security certifications.
- **Is AI automatic?** No. AI is review-first — it suggests; you confirm. Non-AI
...
Where important documents become ready. *(primary)* · Important documents, ready
when life asks. · Your documents, prepared before deadlines. · Organize. Prepare.
Track. Share safely.
